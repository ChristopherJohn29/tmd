...
CREATE TABLE IF NOT EXISTS `mobile_drs`.`user` (
  ...
  PRIMARY KEY (`user_id`),
  INDEX `user_roleID_idx` (`user_roleID` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mobile_drs`.`roles_permission` (
  ...
  PRIMARY KEY (`rp_id`),
  INDEX `rp_rolesID_idx` (`rp_rolesID` ASC) VISIBLE,
  INDEX `rp_permissionsID_idx` (`rp_permissionsID` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mobile_drs`.`patient` (
  ...
  INDEX `patient_hhcID_idx` (`patient_hhcID` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mobile_drs`.`patient_transactions` (
  ...
  PRIMARY KEY (`pt_id`),
  INDEX `pt_patientID_idx` (`pt_patientID` ASC) VISIBLE,
  INDEX `pt_providerID_idx` (`pt_providerID` ASC) VISIBLE,
  INDEX `pt_tovID_idx` (`pt_tovID` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mobile_drs`.`patient_CPO` (
  ...
  INDEX `ptcpo_patientID_idx` (`ptcpo_patientID` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mobile_drs`.`patient_communication_notes` (
  ...
  PRIMARY KEY (`ptcn_id`),
  INDEX `ptcn_patientID_idx` (`ptcn_patientID` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mobile_drs`.`provider_route_sheet` (
  ...
  PRIMARY KEY (`prs_id`),
  INDEX `prs_providerID_idx` (`prs_providerID` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mobile_drs`.`provider_route_sheet_list` (
  ...
  PRIMARY KEY (`prsl_id`),
  INDEX `prsl_hhcID_idx` (`prsl_hhcID` ASC) VISIBLE,
  INDEX `prsl_patientID_idx` (`prsl_patientID` ASC) VISIBLE,
  INDEX `prsl_prsID_idx` (`prsl_prsID` ASC) VISIBLE,
  INDEX `prsl_tovID_idx` (`prsl_tovID` ASC) VISIBLE,
