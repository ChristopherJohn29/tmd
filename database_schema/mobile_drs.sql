...
-- Saturday, 21 March, 2020 06:00:43 PM PST
...
CREATE TABLE IF NOT EXISTS `mobile_drs`.`patient` (
  ...
  `patient_pharmacyPhone` VARCHAR(45) NULL,
...
CREATE TABLE IF NOT EXISTS `mobile_drs`.`patient_communication_notes` (
  ...
  `ptcn_category` ENUM('CPO', 'Medications', 'DME', 'Scheduling', 'Issues', 'HH Comm', 'Billing', 'Misc') NULL,
