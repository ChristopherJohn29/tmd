...
-- Sunday, 23 February, 2020 09:56:12 PM PST
...
CREATE TABLE IF NOT EXISTS `mobile_drs`.`patient_communication_notes` (
  ...
  `ptcn_category` ENUM('CPO', 'Medications', 'DME', 'Scheduling', 'Issues', 'HH Comm', 'Billing', 'Misc') DEFAULT NULL,
  `ptcn_notesFromUserID` INT UNSIGNED DEFAULT NULL,
  PRIMARY KEY (`ptcn_id`),
