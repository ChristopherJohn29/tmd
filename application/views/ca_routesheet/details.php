        ...
        <div class="col-md-12">
          <div class="box">
            ...
            <div class="box-body">
                ...
                {{ form_open("provider_route_sheet_management/route_sheet/form/#{record.0.prs_id}") }}
                 	...
                 	<section class="xrx-info">
                 		...
                 		<div class="row">
                            <div class="col-xs-12">
                 			...
                 			<div class="col-md-12">
                 				<h1 class="name rs">{{ record.0.provider_firstname }}<small>Provider Name</small></h1>
                 			</div>
                 		</div>

                        <div class="row spacer-bottom">
                            <div class="col-md-12">
                                <h4>Date of Service: {{ record.0.prs_dateOfService }}</h4>
                            </div>
                        </div>
                 				...
                 				<div class="table-responsive">
    								...
    								<tbody>
    									...
    									{% for list in record %}
    										...
    										<tr>
    											<td>{{ list.timetotal }}</td>
    											<td>
                                                    <p>
                                                        {{ list.patient_name }}
                                                        <span>
                                                            <strong>DOB:</strong> {{ list.patient_dateOfBirth }}<br>
                                                            ...
                                                            <strong>Supervising MD:</strong> 

                                                            {% if list.supervisingMd %}
                                                              {{ list.supervisingMd.0.provider_firstname }} {{ list.supervisingMd.0.provider_lastname }}
                                                            {% endif %}
    											...
    											<td><p>Reason for Visit : {{ list.pt_reasonForVisit }}</p><p>Type of Visit : {{ list.type_of_visit }}<span>Other Notes: <br>{{ list.prsl_notes|nl2br }}</span></p></td>
    										</tr>
    					...
    					<div class="row no-print">
        					...
        					<div class="col-xs-12 xrx-btn-handler">
                                ...
                                {% if roles_permission_entity.has_permission_name(['print_prs']) %}
                                  ...
                                  <a href="{{ site_url("provider_route_sheet_management/route_sheet/print/#{ record.0.prs_id }") }}" target="_blank" class="btn btn-primary xrx-btn"><i class="fa fa-print"></i> Print</a>
