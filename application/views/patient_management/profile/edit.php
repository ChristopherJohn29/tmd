							...
							{{ form_open("patient_management/profile/save/edit/#{ record.patient_id }", {"class": "xrx-form"}) }}
								...
								<div class="row">									
									...
									<div class="col-md-6 form-group {{ form_error('patient_supervising_MD') ? 'has-error' : '' }}">
										...
										<input type="text" class="form-control" id="supervisingMD" placeholder="" name="patient_supervising_MD" value="{{ set_value('patient_caregiver_family', record.patient_supervising_MD) }}">
