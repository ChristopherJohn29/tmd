    ...
    <div class="table-responsive">
        ...
        <div class="xrx-tabletop-info">
            ...
            <div class="pull-right text-right">
                <a data-sortBtn href="{{ site_url("patient_management/DFV/print_ca/#{ year }/#{ month }/#{ fromDate }/#{ toDate }") }}" target="_blank"><span class="btn btn-primary btn-sm">Print</span></a>
                <a data-sortBtn href="{{ site_url("patient_management/DFV/pdf_ca/#{ year }/#{ month }/#{ fromDate }/#{ toDate }") }}"><span class="btn btn-primary btn-sm">Generate PDF</span></a>
            </div>
        </div>
