								...
								<div class="row">
									...
									<div class="col-md-6 form-group {{ form_error('pt_providerID') ? 'has-error' : '' }}">
										...
										<div class="dropdown mobiledrs-autosuggest-select">
										  	<input type="text" class="form-control" data-mobiledrs-autosuggest-select data-action-url="{{ site_url('ajax/provider_management/profile/search') }}" data-input-target-name="pt_providerID">
