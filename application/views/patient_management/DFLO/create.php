...
{% 
  set scripts = [
    ...
    'dist/js/patient_management/dflo/list'
  ]
%}
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-sm-offset-2">
                            <div class="search-handler">
                                ...
                                {{ form_open("patient_management/DFLO", {"class": "xrx-form"}) }}
                                    
                                    <p class="lead">Due for Lab orders</p>
                        ...
                        <div class="box-body">
                            ...
                            <div class="table-responsive">
                                ...
                                {% if records is defined and records|length > 0 %}
                                    ...
                                    {{ include("patient_management/DFLO/list.php") }}
