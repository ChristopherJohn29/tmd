...
{% set page_title = 'Search Supervising MD' %}

{%

set scripts = [
    'dist/js/patient_management/supervising_md/search',
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-10 col-md-offset-2">
                            <div class="search-handler">
                                ...
                                {{ form_open("patient_management/supervising_MD", {"class": "xrx-form"}) }}
                                    
                                    <p class="lead">Search Supervising MD</p>
                        ...
                        <div class="box-body">
                            ...
                            <div class="table-responsive">
                                ...
                                {% if records is defined and records|length > 0 %}
                                    ...
                                    {{ include("patient_management/supervising_MD/result.php") }}
