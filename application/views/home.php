...
<div class="row">
    ...
    <!-- TABLE: PATIENT LIST -->
        <div class="box">
            ...
            <!-- /.box-body -->
            <div class="box-footer text-center">
            <a href="{{ site_url('provider_management/profile/') }}" class="uppercase">View All Providers</a>
            </div>
        <!-- /.box-footer -->
        </div>
    <!-- /.box -->
    ...
    <!-- /.box-body -->
        <div class="box-footer text-center">
        <a href="{{ site_url('home_health_care_management/profile/') }}" class="uppercase">View All Home Health</a>
        </div>
    <!-- /.box-footer -->
        </div>
    <!-- /.box -->
