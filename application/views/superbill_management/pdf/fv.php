...
<p style="margin:0; padding:0;"><span style="font-size:16px;">Facility Visits</span><br>
			...
			<table style="font-size: 8px;padding: 5px;">
				...
				<tbody>
					<tr>
						...
						<td style="border-bottom: 1px solid #d2d6de;"><?php echo $summary['INITIAL_VISIT_FACILITY']; ?></td>
					</tr>

					<tr>
						<th style="border-bottom: 1px solid #d2d6de;">99337</th>
						<td style="border-bottom: 1px solid #d2d6de;">FOLLOW UP</td>
						<td style="border-bottom: 1px solid #d2d6de;"><?php echo $summary['FOLLOW_UP_FACILITY']; ?></td>
					</tr>
