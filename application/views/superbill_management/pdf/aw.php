...
<table style="font-size: 7px;padding: 5px;">
	<thead>
		<tr>
			<th width="110px" bgcolor="#548bb8" style="color: white;border:1px solid #548bb8;">Patient Name</th>
			...
			<th width="105px" bgcolor="#548bb8" style="color: white;border:1px solid #548bb8">Address</th>
			...
			<th width="80px" bgcolor="#548bb8" style="color: white;border:1px solid #548bb8">Provider</th>
	...
	<tbody>
		<?php foreach($transaction_entity->has_performed_in_list($newTransactions) as $transaction): ?>
			<tr>
				...
				<td width="105px" style="border-bottom: 1px solid #d2d6de;"><?php echo  $transaction->patient_address; ?></td>
