            ...
            <div class="box-body">
             	...
             	<section class="xrx-info">
             		...
             		<div class="row">
             			...
             			<div class="col-md-12">
             				<h1 class="name">Annual Wellness<small>Unbill</small></h1>
             			</div>
             		...
             		{{ form_open("superbill_management/superbill/form_unbill/aw/#{ fromDate|replace({'/': '_'}) }") }}
									...
									<tbody>
										...
										{% for transaction in newTransactions %}
											...
											<tr>
												...
												<td>{{ transaction.get_date_format(transaction.pt_aw_billed	) }}</td>
	             		...
	             		<div class="row no-print">
	                        ...
	                        <div class="col-xs-12 xrx-btn-handler">
	                            ...
	                            <i class="fa fa-credit-card"></i> AW Unbill
	                            </button>
	                        </div>
