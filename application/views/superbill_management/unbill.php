                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-11 col-lg-offset-1">
                            <div class="search-handler">
                                ...
                                {{ form_open("superbill_management/superbill/generateUnbill", {"class": "xrx-form"}) }}
                                    
                                    <p class="lead">Unbill Superbill</p>
                        ...
                        <div class="box-body">
                            ...
                            <div class="table-responsive ">
                                ...
                                {% if summary is defined and summary|length > 0 %}
                                    ...
                                    {{ include("superbill_management/mixins/list_unbill_#{ table_name_page }.php") }}
