	 ...
	 <div class="row">
          ...
          <div class="box">
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Add Specialist</h3>
            </div>
            <!-- /.box-header -->
	            ...
	            <div class="row">
					<div class="col-lg-12">
						<div class="box-body">
							...
							{{ form_open("specialist/profile/save/add", {"class": "xrx-form"}) }}
								...
								<div class="row">
									...
									<div class="col-md-12 form-group {{ form_error('company_name') ? 'has-error' : '' }}">
										...
										<input type="text" class="form-control"  required="true" name="company_name" value="{{ set_value('company_name') }}">
									...
									<div class="col-md-12 form-group {{ form_error('contact_person') ? 'has-error' : '' }}">
										...
										<input type="text" class="form-control"  required="true" name="contact_person" value="{{ set_value('contact_person') }}">
									...
									<div class="col-md-12 form-group {{ form_error('address') ? 'has-error' : '' }}">
										...
										<input type="text" class="form-control" required="true" name="address" value="{{ set_value('address') }}">
									...
									<div class="col-md-6 form-group {{ form_error('phone_number') ? 'has-error' : '' }}">
										...
										<input type="phone" class="form-control"  required="true" name="phone_number" value="{{ set_value('phone_number') }}">
									...
									<div class="col-md-6 form-group {{ form_error('fax') ? 'has-error' : '' }}">
										...
										<input type="phone" class="form-control" name="fax" value="{{ set_value('fax') }}">
                           ...
                           <textarea class="form-control" rows="5" name="services_provided">{{ set_value('services_provided') }}</textarea>
                           ...
                           <textarea class="form-control" rows="5" name="notes">{{ set_value('notes') }}</textarea>
									...
									<div class="col-md-12 form-group xrx-btn-handler">
                                        <a href="{{ site_url('specialist/profile') }}" class="btn btn-default xrx-btn cancel">
					              		...
					              		<button type="submit" class="btn btn-primary xrx-btn">
											<i class="fa fa-check"></i> Add Specialist
										</button>
					              	</div>
